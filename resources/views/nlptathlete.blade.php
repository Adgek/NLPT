				...
				<div class="row first-content">
					...
					<div class="col-md-6 nlptathlete-text">
						...
						<div class="text-center">
							<button href="#" type="button" class="btn btn-primary action-btn" v-on:click="showAction=true">Contact us to get started!</button>
			...
			<div class="container">
				...
				<div class="step1 step">
					...
					<div class="row">
						...
						<div class="col-md-5">
							<img class="nlptathlete-picture" src="/images/assessment.jpg">
						</div>
					</div>
				</div>
				<div>
